...
def fit_file_parse(*, file_path):
    ...
    print(f"fit_file_parse datetime type: {df['datetime'].dtype}")
    return df


def gpx_file_parse(*, file_path):
    parsed_data = []
    ...
    print(f"gpx_file_parse datetime type: {df['datetime'].dtype}")
    return df


def tcx_file_parse(*, file_path):
    parsed_data = []
    ...
    print(f"tcx_file_parse datetime type: {df['datetime'].dtype}")
    return df
...
def activities_coordinates_import(*, activities_directory):
    ...
    for activities_file in activities_files:
        try:
            ...
            if activities_file.endswith('.fit'):
                df = fit_file_parse(file_path=activities_file)
            elif activities_file.endswith('.gpx'):
                df = gpx_file_parse(file_path=activities_file)
            elif activities_file.endswith('.tcx'):
                df = tcx_file_parse(file_path=activities_file)
            else:
                continue
